...
import './menuStore3.css'
import storeProducts3 from './storeProducts3.json'
...
const MenuStore3 = () => {
  const [data, setData] = useState([])
    ...
    useEffect(() => {
        ...
        setData(storeProducts3.products);
    },[]);

    const thirdMenu = dataStores.length > 0 ? dataStores[2] : null;
  ...
  return (
    <div className='menu-right'>
        <div className='header-menu-right'>                                 
            {thirdMenu && <h2 className='menu-right-text'>{thirdMenu.name} menu</h2>}             
        </div>
