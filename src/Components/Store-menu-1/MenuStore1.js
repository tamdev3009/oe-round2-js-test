...
const MenuStore1 = () => {
    ...
    useEffect(() => {
        ...
        setData(storeProducts1.products);
    },[]);

    const firstMenu = dataStores.length > 0 ? dataStores[0] : null;
  ...
  return (
    <div className='menu-right'>
        <div className='header-menu-right'>                                 
            {firstMenu && <h2 className='menu-right-text'>{firstMenu.name} menu</h2>}             
        </div>
